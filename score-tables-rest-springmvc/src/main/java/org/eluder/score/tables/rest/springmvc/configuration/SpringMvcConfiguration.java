...
import org.eluder.score.tables.rest.springmvc.interceptor.CorsHandlerInterceptor;
...
public class SpringMvcConfiguration extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public CorsHandlerInterceptor corsHandler() {
    ...
    public void addInterceptors(final InterceptorRegistry registry) {
        registry.addInterceptor(corsHandler());
    }
}
